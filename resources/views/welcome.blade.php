...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">MAESTRO</div>
                <div class="masthead-heading text-uppercase">音楽レッスンのマッチング</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="{{url('user/login')}}">レッスンを受けたい方はこちら</a>
                <a class="btn btn-success btn-xl text-uppercase ml-3" href="{{url('teacher/login')}}">先生はこちら</a>
            </div>
        </header>
        <!-- Services-->
